...
export default function CompanyTeamSetupScreen() {
  ...
  return <ScreenContainer className="px-5" containerClassName="bg-background"><ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
    ...
    <TouchableOpacity onPress={() => router.push("/company-territory-setup" as never)} style={styles.territoryStep}><MaterialIcons name="map" size={18} color="#0E7490" /><View style={styles.alignEnd}><Text style={styles.territoryStepTitle}>الخطوة التالية: مناطق العمل</Text><Text style={styles.territoryStepText}>أنشئ مناطق التغطية وحدودها قبل إضافة المندوبين وربطهم بالمناطق.</Text></View><MaterialIcons name="chevron-left" size={19} color="#0E7490" /></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  territoryStep: { flexDirection: "row-reverse", gap: 8, alignItems: "center", backgroundColor: "#EAF7FA", borderRadius: 14, padding: 12, marginTop: 10 }, territoryStepTitle: { color: "#0E7490", fontSize: 11, fontWeight: "900", textAlign: "right" }, territoryStepText: { color: "#397C90", fontSize: 10, lineHeight: 15, marginTop: 3, textAlign: "right" },
});
