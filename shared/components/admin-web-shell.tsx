...
const companyNavCategories: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "إعدادات وهوية الشركة", icon: "settings-suggest", href: "/company-setup" },
      { label: "إعدادات النظام العامة", icon: "settings", href: "/settings" },
    ],
  },
];
  ...
  if (!session) {
    return (
      <View style={styles.mobileNotice}>
        ...
        <Text style={styles.mobileCopy}>تحتاج إلى حساب معتمد للوصول إلى لوحة التحكم.</Text>
        <TouchableOpacity
    ...
    <View style={styles.root}>
      ...
      <View style={[styles.sidebar, isSidebarCollapsed ? styles.sidebarCollapsed : styles.sidebarExpanded]}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.replace("/company" as never)}
          activeOpacity={0.85}
        >
          ...
          {!isSidebarCollapsed && (
            <View style={styles.brandTextCol}>
              ...
              <Text style={styles.brandSubtitle}>
                {profile?.active_company_name ? `إدارة ${profile.active_company_name}` : "لوحة إدارة الشركة"}
              </Text>
            </View>
          )}
        </TouchableOpacity>
        ...
        <ScrollView style={styles.navScroll} showsVerticalScrollIndicator={false}>
          <View style={styles.navCategoryList}>
            {companyNavCategories.map((category, catIdx) => (
        ...
        <View style={styles.sidebarFooter}>
          ...
          {!isSidebarCollapsed && (
            <View style={styles.statusIndicator}>
              ...
              <Text style={styles.statusText}>النظام متصل بالسيرفر</Text>
            </View>
          )}
        </View>
      </View>
      ...
      <View style={styles.mainContainer}>
        ...
        <View style={styles.topbar}>
          {/* Header Right: Title & Breadcrumbs */}
          <View style={styles.topbarRight}>
            ...
            <View style={styles.titleWrapper}>
              ...
              <Text style={styles.breadcrumbText}>لوحة الإدارة / {title}</Text>
            </View>
          </View>
