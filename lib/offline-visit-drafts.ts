...
export type OfflineVisitPayload = { result: string; note: string; followUpAction?: string; followUpDate?: string; reportPriority: "عالية" | "متوسطة" | "منخفضة"; attachments?: VisitAttachment[]; location?: { latitude: number; longitude: number; accuracy?: number | null }; isInsideTerritory: boolean; collectionAmount?: number; revenueAmount?: number; receiptReference?: string; medicalInteractionType?: "زيارة حضورية" | "اتصال هاتفي" | "مكالمة أونلاين" | "اجتماع مستشفى"; medicalVisitGoal?: "تعريف بمنتج" | "ترويج علمي" | "متابعة وصف" | "دعوة فعالية" | "طلب معلومات" | "متابعة استفسار"; medicalVisitPlace?: "عيادة خاصة" | "مستشفى" | "مركز إحالة"; medicalPrescribingLevel?: "مرتفع" | "متوسط" | "منخفض" | "غير واصف"; promotedProduct?: string; scientificMessage?: string; doctorInterest?: "مرتفع" | "متوسط" | "منخفض" | "طلب معلومات" | "لا اهتمام"; medicalFeedback?: string } & VisitProductContextInput;
